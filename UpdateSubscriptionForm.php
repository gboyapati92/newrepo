...
class UpdateSubscriptionForm extends FormBase
{
    ...
    public function submitForm(array &$form, FormStateInterface $form_state){
      ...
      $tier1 = $keys->getKey('promotion_tiers')->getKeyValues()['tier1-prefix'];
      ...
      $createSubscription = $productSubscriptionsController->updateProductSubscription($currentUserId[0], $payload, $currentUserId[1]);
